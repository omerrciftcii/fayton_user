...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> addNewLocation() async {
    ...
    try {
      await users.doc(authProvider.currentUser?.userId).update({
              ...
              TextButton(
                ...
                child: Align(
                  ...
                  child: Row(
                    ...
                    children: [Text('Share your Location'), isLocation ? Icon(Icons.check) : Container()],
                  ),
                ),
              ),
              TextButton(
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          ...
          actions: [
            ...
            locLongitude == 0.1 && locLatitude == 0.1
                ? SizedBox()
                : IconButton(
                    onPressed: () {
